      ...
      {sizeLoader ? (
        <header className={styles.header}>
          <div className={styles.menuIcons}>
            <label htmlFor="check" className={styles.icons}>
              <HiBars3CenterLeft
                className={`${styles.icon} ${styles.menuIcon} text-2xl`}
              />
              <IoCloseOutline
                className={`${styles.icon} ${styles.close} ${styles.closeIcon} text-2xl`}
              />
            </label>
          </div>
          ...
          <div className={`${styles.right} flex gap-4`}>
            <CiShoppingCart
              ...
              className="text-2xl text-zinc-600 cursor-pointer hover:text-black"
            />
            <CiUser
            ...
            {showModal && (
              <div
                className="absolute desktop:top-120 mobile:top-[2.8rem] mobile:left-[13rem] phablet:left-[15rem] w-[10rem] bg-white flex gap-4 justify-center left-48 p-5 h-32 rounded shadow-md"
                ref={modalRef}
              >
                <div>
          ...
          <Link href="/" className={`${styles.logo} ${styles.left}`}>
            gadget
          </Link>
          ...
          <nav className={styles.navbar}>
            ...
            <Link href="/contact" style={{ "--i": 3 }} {...({} as AnchorProps)}>
              Contact
            </Link>
          </nav>
        </header>
        ...
        <header className={`${styles.header} px-32`}>
          ...
          <label htmlFor="check" className={styles.icons}>
            ...
            <i className={`${styles.icon} ${styles.close} ${styles.closeIcon}`}>
              &#10005{" "}
            </i>
          </label>
          ...
          <div className={`${styles.right} flex gap-4 relative`}>
            ...
            {showModal && (
              <div
                className="absolute top-10 w-48 bg-white flex gap-4 justify-center -left-55 p-5 h-32 rounded shadow-md"
                ref={modalRef}
              >
                <div>
                  <ul className="flex flex-col gap-3">
